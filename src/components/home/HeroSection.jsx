  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-end" style={{ transition: "border-radius 0.1s ease-out" }}>
      ...
      <motion.div
        ...
        <div className="md:hidden flex flex-col gap-3 pr-6">
          <motion.div
            ...
            <h1 className={`text-5xl md:text-6xl text-accent leading-none tracking-tighter ${lang === 'ru' ? 'font-sans font-bold' : 'font-heading font-extralight'}`} style={{ letterSpacing: "-0.02em" }}>
          ...
          <motion.div
            ...
            <h1 className={`text-5xl md:text-6xl text-primary-foreground leading-none tracking-tighter ${lang === 'ru' ? 'font-sans font-bold' : 'font-heading font-extralight'}`} style={{ letterSpacing: "-0.02em" }}>
        ...
        <div className="hidden md:block">
          <motion.h1
            ...
            className={`text-6xl md:text-[9vw] lg:text-[8.5vw] text-accent leading-tight tracking-tighter ${lang === 'ru' ? 'font-sans font-bold' : 'font-heading font-extralight'}`} style={{ letterSpacing: "-0.025em", textWrap: "balance" }}>
      ...
      <motion.div
        ...
        <h1 className={`text-6xl md:text-[9vw] lg:text-[8.5vw] text-primary-foreground leading-none tracking-tighter text-right ${lang === 'ru' ? 'font-sans font-bold' : 'font-heading font-extralight'}`} style={{ letterSpacing: "-0.025em" }}>

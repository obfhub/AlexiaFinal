...
export default function CommunityImpactSection() {
  ...
  const stats = [
    {
      icon: Users,
      label: t.communityImpact?.members || "Active Members",
      value: 250,
      suffix: "+",
      color: "text-accent",
    ...
    {
      icon: Zap,
      label: t.communityImpact?.classes || "Classes Completed",
      value: 800,
      suffix: "+",
      color: "text-blue-500",
    ...
    {
      icon: Star,
      label: t.communityImpact?.rating || "Average Rating",
      value: 5,
      suffix: "/5",
      ...
      <div className="max-w-6xl mx-auto">
            ...
            return (
              ...
              >
                ...
                >
                  {/* Icon */}
                  <motion.div
                    className={`w-14 h-14 rounded-full ${stat.bgColor} flex items-center justify-center mb-6`}
                  ...
                  {/* Decorative line */}
                  <motion.div
                    className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r from-transparent via-${stat.color.split('-')[1]} to-transparent rounded-full`}
                    initial={{ width: 0 }}
        ...
        >
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            {t.communityImpact?.subtitle || "Discover how thousands of riders have transformed their fitness journey at Alexia. Start your story today."}
          </p>
        </motion.div>
      </div>
    </section>
